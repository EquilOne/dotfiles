...
assert_file "$HOME/.config/shell/15_functions/03_fzf_functions.sh"
assert_file "$HOME/.config/shell/15_functions/04_yazi_integration.sh"
assert_file "$HOME/.config/shell/21_zsh_completions.sh"
assert_file "$HOME/.config/shell/22_alias_completions.sh"
assert_file "$HOME/.config/shell/25_completions/01_carapace.sh"
assert_file "$HOME/.config/shell/25_completions/02_uv.sh"
assert_file "$HOME/.config/shell/25_completions/03_hyprctl.sh"
assert_file "$HOME/.config/shell/30_tools/01_direnv_init.sh"
assert_file "$HOME/.config/shell/30_tools/02_fzf_init.sh"
assert_file "$HOME/.config/shell/30_tools/03_keychain_init.sh"
assert_file "$HOME/.config/shell/30_tools/04_zoxide_init.sh"
assert_file "$HOME/.config/shell/30_tools/05_zsh_vi_mode.sh"
