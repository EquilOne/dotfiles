...
> **Load during Step 5 (Generate Report)** of the Skill Judge evaluation protocol. Use this checklist to verify the evaluation output covers all critical dimensions before finalizing the report.
